...
# This is the part where we bring data of the previously loaded stock from the local storage for prediction.
...
# Give the User access to selection of what ML model they would like to use for prediction
ml_model = {
...
modelKey= ""
# Center-align buttons and display each button in a separate column
...
# Display the selected model name if a button was clicked
if modelKey:
...
prediction_days = st.selectbox('Select the number of days for prediction', [10, 20, 30])
